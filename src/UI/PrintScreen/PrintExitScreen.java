...
public class PrintExitScreen implements PrintScreen {
    ...
    public void print() {
        System.out.println("""                                  
                                ...
                                Dolphin Member Management is developed by the famous group TEAM SCUFFED.
                                Found in 2022 April 12. by two dedicated developers Martin Hansen and Stefan
                                ...
                                He, and hes protage of scuffed developers, developed a controller software,
                                that was meant to prevent collisions with other trains. He caused havoc on several 
                                stations as trains collided due to really scuffed code. Because of this incident,
                                Martin Hansen is banned in the United States of America, and is prohibited work
                                and development on any software that involves trains, busses, flights, and other
                                areas that could cause harm on people. Also, he must not use the train anymore.
                                ...
                                Martin Hansen (Scuff Emperor)
                                Mail: MH2012@outlook.dk
                                
                                Stefan Jensen (Scuff padawan)
