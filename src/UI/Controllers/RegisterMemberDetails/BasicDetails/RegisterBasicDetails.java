package UI.Controllers.RegisterMemberDetails.BasicDetails;

import Backend.Competition.Result.CreateTrainingResults.Discipline;
import Backend.Contracts.BackendDomain;
import UI.Contracts.ReadUserInput;
import UI.Controllers.RegisterMemberDetails.BasicDetails.BirthDate.ReadBirthDay;
import UI.Controllers.RegisterMemberDetails.BasicDetails.Disciplines.ReadDisciplinesFromUser;
import UI.Controllers.RegisterMemberDetails.BasicDetails.Name.MemberNameNotValid;
import UI.Controllers.RegisterMemberDetails.BasicDetails.Name.ReadMemberFullName;
import UI.Controllers.RegisterMemberDetails.BasicDetails.Status.ReadMemberStatus;
