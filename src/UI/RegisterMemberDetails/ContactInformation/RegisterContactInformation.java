package UI.RegisterMemberDetails.ContactInformation;

import Backend.Contracts.BackendDomain;
import UI.Contracts.ReadUserInput;
import UI.ReadUserInput.ConsoleHaltForInput;
import UI.RegisterMemberDetails.ContactInformation.Address.InvalidAddressFormatException;
import UI.RegisterMemberDetails.ContactInformation.Address.ReadDanishAddress;
import UI.RegisterMemberDetails.ContactInformation.Mail.InvalidMailFormatException;
import UI.RegisterMemberDetails.ContactInformation.Mail.ReadMail;
import UI.RegisterMemberDetails.ContactInformation.Phone.InvalidPhoneFormatException;
import UI.RegisterMemberDetails.ContactInformation.Phone.ReadDanishPhoneNumber;
